# Домашнее задание к занятию «Базы данных в облаке» `Герасимчук Андрей`
...
![1](https://github.com/AndrejGer/Netology/blob/main/db_cloud/img/1.png)

![2](https://github.com/AndrejGer/Netology/blob/main/db_cloud/img/2.png)